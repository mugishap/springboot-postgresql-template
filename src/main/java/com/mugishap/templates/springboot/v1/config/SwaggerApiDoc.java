...
public class SwaggerApiDoc extends WebMvcConfigurationSupport {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).directModelSubstitute(LocalDate.class, Date.class)
                ...
                }).select().apis(RequestHandlerSelectors.basePackage("com.mugishap.templates.springboot.v1.controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("NE Springboot API").description("APIs Documentation")
                .termsOfServiceUrl("https://github.com/mugishap/neprep")
                .version("1.0").build();
    }
}
